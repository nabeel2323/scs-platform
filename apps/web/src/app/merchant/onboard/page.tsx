...
import { createStore, createWarehouse, registerDocument, submitVerification } from '../../../lib/api';
  ...
  async function handleNext() {
    ...
    if (currentStep === 0) {
      ...
      try {
        ...
        // In a real app, orgId comes from the user's active org
        const orgId = session ? '00000000-0000-0000-0000-000000000001' : '';
        if (!orgId) { setError('No active organization. Please login again.'); return; }
