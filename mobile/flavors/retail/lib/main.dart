// Retail flavor entry point
//
// This file is a convenience alias. The actual entry point is lib/main.dart.
// Run with: flutter run -t flavors/retail/lib/main.dart --dart-define=FLAVOR=retail
//
// Or simply: flutter run --dart-define=FLAVOR=retail
//
...
void main() {
  ...
  runApp(const ProviderScope(child: ScsApp(flavor: AppFlavor.retail)));
}
